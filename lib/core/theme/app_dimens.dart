...
class AppDimens {
  ...
  //device dimens
  static double width = ui.window.physicalSize.width/ui.window.devicePixelRatio;
  static double height = ui.window.physicalSize.height/ui.window.devicePixelRatio;
  static double paddingTop = ui.window.padding.top/ui.window.devicePixelRatio;
  static double paddingLeft = ui.window.padding.left/ui.window.devicePixelRatio;
  static double paddingRight = ui.window.padding.right/ui.window.devicePixelRatio;
  static double paddingBottom = ui.window.padding.bottom/ui.window.devicePixelRatio;
  static double keyboardheight = ui.window.systemGestureInsets.bottom/ui.window.devicePixelRatio;
  ...
  static const paddingPage = const EdgeInsets.symmetric(
    horizontal: 16,
    vertical: 20,
  );

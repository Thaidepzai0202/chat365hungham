...
class AppConst {
  ...
  static late double maxMessageBoxWidth = 450;
  ...
  static double kReactionBarHeight = 25;

  static double kReactionBarMargin = 4;

  // du doan la padding cua box chat, chieu rong cua thanh truot o man tin nhan la 10
  static double kPadding = 10;

  static double kMargin = 10;

  static double kDetailEmotionBarWidth = kBottomNavigationBarItemIconSize * kEmotionCount;

  static List<double> kExtraMessageBox = [kDetailEmotionBarWidth];

  static int maxEmotionInBarUnderMessageBox = 2;

  static int maxNumberOfEmoji = 9;

  static double extraMessageBoxWidth = AppConst.kExtraMessageBox.reduce((value, element) {
    if (element > value) {
      value = element;
    }
    return value;
  ...
  static double kDetailEmotionBarHeight = kEmotionSize;
  ...
  static const List<String> supportVideoTypes = [
    'mp4',
    'mov',
    'mpv',
    'mpe',
  ...
  static const List<String> supportAudioTypes = [
    'wav',
    'm4a',
  ];

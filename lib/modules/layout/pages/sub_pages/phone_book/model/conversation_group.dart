class ConversationGroup {
  ...
  factory ConversationGroup.fromJson(Map<String, dynamic> json) => ConversationGroup(
    ...
    listMember:(json["listMember"] == null || json["listMember"] == []) ? [] : List<ListMember>.from(json["listMember"].map((x) => ListMember.fromJson(x))),
...
class ListMember {
  ...
  factory ListMember.fromJson(Map<String, dynamic> json) => ListMember(
    ...
    deleteTime: json["deleteTime"]??0,
    deleteType: json["deleteType"]??0,
    favoriteMessage: List<String>.from(json["favoriteMessage"].map((x) => x)),
    liveChat: json["liveChat"] == null ? null : LiveChat.fromJson(json["liveChat"]),
  );
...
class LiveChat {
  ...
  factory LiveChat.fromJson(Map<String, dynamic> json) => LiveChat(
    ...
    fromConversation: json["fromConversation"]??0,
...
final messageTypeValues = EnumValues({
  ...
  "sendFile": MessageType.SEND_FILE,

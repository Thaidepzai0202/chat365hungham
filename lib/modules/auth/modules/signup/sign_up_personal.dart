...
class InputSignUpPersonal extends StatefulWidget {
  @override
  _InputSignUpPersonalState createState() => _InputSignUpPersonalState();
}

class _InputSignUpPersonalState extends State<InputSignUpPersonal> {
  ...
  TextEditingController _textPass2Controller = TextEditingController();
    ...
    return MultiBlocListener(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              Text(
                AppLocalizations.of(context)!.signUpAccPersonal,
                style: TextStyle(
                    fontSize: 20,
  ...
  ValueNotifier<bool> _onOff2 = ValueNotifier(true);

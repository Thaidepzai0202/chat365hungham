import 'package:app_chat365_pc/utils/data/enums/day_of_week.dart';
...
extension DateTimeExt on DateTime {
  ...
  ///
  // viết thêm 1 hàm check ngày giống nhau thì hiện hôm nay
  String diffWith({
    DateTime? dateTime,
    ...
    if (showSpecialTime) {
      ...
      //thêm 1 cái if ngày giống nhau thì hiện hôm nay
      if (diffWithHM.inHours < 24 && diffDateTime.isToday) return 'Hôm nay';
    }
...
extension NullableDateTimeExt on DateTime? {
  ...
  //   String time = DateFormat('HH:mm:ss.msms')
  // }
}

...
class UserStatus extends Equatable {
  ...
  static const values = [
    none,
    // TL 6/1/2024: Thiếu mất "none" nên console cứ báo lỗi "Không tìm thấy UserStatus.id == 0"
    online,
    offline,
    notDisturb,
    hide,
  ...
  /// TL 11/1/2024: Dùng để lưu local
  factory UserStatus.fromJson(Map<String, dynamic> json) {
    return UserStatus.fromId(json["id"]);
  }
}

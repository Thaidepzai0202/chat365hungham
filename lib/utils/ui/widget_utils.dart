...
class WidgetUtils {
  static CupertinoActivityIndicator loadingCircle(BuildContext context) =>
      CupertinoActivityIndicator(
        color: context.theme.primaryColor,
        radius: 30 / 2,
      );

  static Container centerLoadingCircle(BuildContext context) => Container(
  ...
  static Row getFormFieldPrefixIcon(BuildContext context, String assetPath) =>
      Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          const SizedBox(width: 18),
  ...
  static Row getFormFieldColorPrefixIcon(String assetPath,
  ...
  static Row getFormFieldColorSuffixIcon(String assetPath, {Color? color}) =>
      Row(
        mainAxisSize: MainAxisSize.min,
        children: [
          SvgPicture.asset(
  ...
  // static WillPopScope getWillPopScope(BuildContext context, Widget child) =>
  //     WillPopScope(
  //       onWillPop: () async => await AppDialogs.toast('Ấn lần nữa để thoát')

...
import 'package:app_chat365_pc/common/Widgets/form/social_textfield/util/regular_expressions.dart';
import 'package:app_chat365_pc/common/Widgets/form/social_textfield/util/social_text_span_builder.dart';
...
class SocialTextEditingController extends TextEditingController {
  ...
  final Map<DetectedType, RegExp> _regularExpressions = {
    ...
    DetectedType.quick_text: atQuickRegExp,
  ...
  TextSpan buildTextSpan(
    ...
    return SocialTextSpanBuilder(
            ...
            onTapDetection: onTapDetectedContentDetection,

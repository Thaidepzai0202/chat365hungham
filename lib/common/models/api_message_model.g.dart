...
class ApiReplyMessageModelAdapter extends TypeAdapter<ApiReplyMessageModel> {
  @override
  final int typeId = 14;

  @override
  ApiReplyMessageModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
  ...
  @override
  void write(BinaryWriter writer, ApiReplyMessageModel obj) {
    writer
      ..writeByte(6)
      ..writeByte(0)
      ..write(obj.messageId)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ApiReplyMessageModelAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}

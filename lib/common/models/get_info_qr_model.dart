...
LoginInfoQrModel loginInfoQrModelFromJson(String str) =>
    LoginInfoQrModel.fromJson(json.decode(str));

String loginInfoQrModelToJson(LoginInfoQrModel data) =>
...
class LoginInfoQrModel {
  ...
  factory LoginInfoQrModel.fromJson(Map<String, dynamic> json) =>
      LoginInfoQrModel(

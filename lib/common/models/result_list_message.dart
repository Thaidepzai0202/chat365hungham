...
ResultListMessage resultListMessageFromJson(String str) =>
    ResultListMessage.fromJson(json.decode(str));

String resultListMessageToJson(ResultListMessage data) =>
...
class ResultListMessage {
  ...
  factory ResultListMessage.fromJson(Map<String, dynamic> json) =>
      ResultListMessage(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        listMessages: json["listMessages"] == null
            ? []
            : List<ListMessage>.from(
                json["listMessages"].map((x) => ListMessage.fromJson(x))),
      );

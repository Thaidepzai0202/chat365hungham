...
class ChatItemModelAdapter extends TypeAdapter<ChatItemModel> {
  ...
  ChatItemModel read(BinaryReader reader) {
    ...
    return ChatItemModel(
      ...
      numberOfUnreadMessage: fields[1] as int,
      ...
      lastMessages: (fields[23] as List?)?.cast<SocketSentMessageModel>(),
      deleteTime: fields[19] as int?,
      isNotification: fields[20] as bool,
      deputyAdminId: (fields[21] as List).cast<int>(),
      memberApproval: fields[22] as int?,
    );
  }
  ...
  void write(BinaryWriter writer, ChatItemModel obj) {
    writer
      ...
      ..writeByte(21)
      ..write(obj.deputyAdminId)
      ..writeByte(22)
      ..write(obj.memberApproval)
      ..writeByte(23)
